...
import 'student_group_statistic.dart';

class StudentGroupsForStatistic extends StatefulWidget {
  const StudentGroupsForStatistic({super.key});

  @override
  _StudentGroupsForStatisticState createState() => _StudentGroupsForStatisticState();
}

class _StudentGroupsForStatisticState extends State<StudentGroupsForStatistic> {
                    ...
                    leading: Padding(
                      ...
                      child: Container(
                        ...
                        onTap: () {
                          ...
                          MaterialPageRoute(builder: (BuildContext context) => StudentGroupStatistic(groupId: _groups[index].getId)));
                        },
                  ),);
                }),
              );
